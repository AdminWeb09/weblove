  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 to-red-100 flex flex-col items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 max-w-md w-full">
        ...
        <div className="mb-6">
          <img 
            ...
            alt={currentPage === 0 ? "Foto pacar tersayang dengan senyum manis dan latar belakang romantis" : 
                 currentPage === 1 ? "Pasangan berjalan berpegangan tangan di saat senja yang romantis" :
                 currentPage === 2 ? "Pasangan berpelukan dengan simbol hati dan percikan cahaya" :
                 "Momen mesra pasangan dengan latar belakang lampu berkelap-kelip"}
      ...
      <footer className="mt-8 text-center text-pink-400">
        <p>Dibuat dengan ❤️ untuk pacar tersayang</p>
      </footer>
    </div>
  );
};
